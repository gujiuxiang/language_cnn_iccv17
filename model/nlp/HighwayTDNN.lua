...
function HighwayTDNN.mlp(input_size, output_size, num_layers, bias, f)
    ...
    for i = 1, num_layers do        
        output = f(nn.Linear(input_size, output_size)(inputs[i]))
        transform_gate = nn.Sigmoid()(nn.AddConstant(bias)(nn.Linear(input_size, output_size)(inputs[i])))
