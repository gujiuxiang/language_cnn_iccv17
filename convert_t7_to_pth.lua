...
model = '/media/jxgu/github/text2im_jxgu/image.torch/reed2016generative/pretrained/coco_fast_t70_nc3_nt128_nz100_bs64_cls0.5_ngf196_ndf196_100_net_G.t7'

torch.manualSeed(123)
torch.setdefaulttensortype('torch.FloatTensor') -- for CPU

local checkpoint = torch.load(model)
local protos = checkpoint
...
local savefile =  'coco_fast_t70_nc3_nt128_nz100_bs64_cls0.5_ngf196_ndf196_100_net_G_cpu.t7' -- append "cpu.t7" to filename
