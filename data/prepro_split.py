...
sys.path.append('/home/jxgu/github/cvpr2017_im2text_jxgu')
from misc.resnet_utils import myResnet

resnet = models.resnet101()
resnet.load_state_dict(torch.load('/media/jxgu/win/model/resnet/resnet101-5d3b4d8f.pth'))
