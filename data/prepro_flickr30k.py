...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='flickr30k_raw.json', help='input json file to process into hdf5')
  parser.add_argument('--num_val', default=1000, type=int, help='number of images to assign to validation data (for CV etc)')
  parser.add_argument('--output_json', default='data_flickr30k.json', help='output json file')
  parser.add_argument('--output_h5', default='data_flickr30k.h5', help='output h5 file')
